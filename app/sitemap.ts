...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/macon/camera-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/macon/back-glass-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/macon/button-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/macon/macbook-keyboard-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/macon/warner-robins-iphone-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${baseUrl}/macon/warner-robins-ipad-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/macon/warner-robins-macbook-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/macon/byron-iphone-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${baseUrl}/macon/perry-iphone-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${baseUrl}/macon/forsyth-iphone-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${baseUrl}/macon/houston-county-phone-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${baseUrl}/macon/peach-county-phone-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${baseUrl}/macon/monroe-county-phone-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${baseUrl}/macon/bibb-county-phone-repair`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${baseUrl}/macon/accessories`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
  ...
  const blogSlugs = [
    ...
    "macbook-battery-issues-swelling-macon",
    "water-damage-phone-repair-cost-houston-county",
  ];
