...
export const metadata: Metadata = {
  ...
  keywords: ["MacBook repair Macon GA", "MacBook screen repair Macon", "MacBook screen replacement Macon GA", "MacBook keyboard repair Macon", "MacBook battery replacement Macon GA", "MacBook Air repair Macon", "MacBook Pro repair Macon", "MacBook logic board repair Macon", "MacBook repair near me Macon", "MacBook not turning on Macon", "laptop repair Macon GA", "Apple laptop repair Macon", "MacBook M1 M2 repair Macon", "best MacBook repair Macon Georgia", "same day MacBook repair Macon GA"],
...
const serviceSchema = {
  ...
  hasOfferCatalog: { "@type": "OfferCatalog", name: "MacBook Repair Services", itemListElement: [
    { "@type": "Offer", itemOffered: { "@type": "Service", name: "MacBook Screen Replacement", description: "MacBook Air and Pro Retina screen replacement for all models" }, priceSpecification: { "@type": "UnitPriceSpecification", price: "299", priceCurrency: "USD", unitText: "starting at" } },
...
const pricingData = [
  ...
  { model: 'MacBook Pro 14"', screen: "$549", battery: "$199", keyboard: "$299", time: "Same day" },
  { model: 'MacBook Pro 16"', screen: "$699", battery: "$219", keyboard: "$349", time: "1-2 days" },
];
...
const comparisonData = [
  ...
  { feature: "M1/M2/M3 Expertise", diy: false, competitor: false, us: true },
