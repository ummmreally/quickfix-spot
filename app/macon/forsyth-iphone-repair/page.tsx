...
export const metadata: Metadata = {
  title: "iPhone Repair Forsyth GA | Near Monroe County | Tech Medics Macon",
  description: "Expert iPhone repair near Forsyth & Monroe County. Affordable screen & battery service. 25-min drive via I-75. Call (478) 259-6371.",
  keywords: ["iPhone repair Forsyth GA", "phone repair Monroe County", "iPhone screen Forsyth", "cell phone repair Juliette GA"],
};

export default function ForsythIPhoneRepairPage() {
  return (
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
              iPhone Repair Near Forsyth GA
            </h1>
            <p className="text-xl text-slate-600 mb-6">
              Serving Forsyth, Juliette & Monroe County
            </p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">Directions from Forsyth</h2>
            <p className="text-lg text-slate-700 mb-4">
              Tech Medics is at <strong>3742 Eisenhower Parkway, Macon</strong> — just 25 minutes south via I-75.
            </p>
            <a
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Link href="/macon/monroe-county-phone-repair" className="text-blue-600 hover:text-blue-800 font-semibold">
      ...
      <section className="bg-blue-600 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Drive down from Forsyth today. Fast, affordable repair.
          </p>
          <a
            href="tel:4782596371"
