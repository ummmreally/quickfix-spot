...
const serviceSchema = {
  ...
  hasOfferCatalog: { "@type": "OfferCatalog", name: "iPad Repair Services", itemListElement: [
    { "@type": "Offer", itemOffered: { "@type": "Service", name: "iPad Screen Replacement", description: "iPad screen and glass replacement for all models including iPad Pro M4, Air M3, Mini 7th gen" }, priceSpecification: { "@type": "UnitPriceSpecification", price: "99", priceCurrency: "USD", unitText: "starting at" } },
...
const faqs = [
  { question: "How much does iPad screen repair cost in Macon GA?", answer: "iPad screen repair starts at $99 for standard iPads. iPad Air M3 repairs run $199-$249, iPad Pro M4 (11\") $349, and iPad Pro M4 (13\") $449. Call (478) 259-6371 for an exact quote on your model." },
  { question: "How long does iPad screen replacement take?", answer: "Most iPad screen replacements are completed in 1-2 hours. iPad Pro M4 models with OLED displays may take 2-3 hours. We offer same-day service for all iPad models." },
  { question: "Do you repair the new iPad Pro M4 and iPad Air M3?", answer: "Yes! We stock parts for every 2026 iPad model including iPad Pro M4 (11\" and 13\"), iPad Air M3, iPad Mini 7th gen, and iPad 11th gen, plus all older generations." },
  { question: "Can you fix a cracked iPad screen that still works?", answer: "Absolutely. Even hairline cracks can worsen over time and compromise touch sensitivity or water resistance. We recommend getting it replaced early — it's faster and cheaper than waiting for the damage to spread." },
  { question: "Do you replace iPad batteries?", answer: "Yes — if your iPad dies quickly, won't charge past 80%, or shows degraded Battery Health, we can swap it. We carry batteries for every iPad generation and most replacements take 1-2 hours." },
];
