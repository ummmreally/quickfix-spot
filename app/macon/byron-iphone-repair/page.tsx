...
export const metadata: Metadata = {
  title: "iPhone Repair Byron GA | Near Peach County | Tech Medics Macon",
  description: "Expert iPhone repair near Byron & Peach County. Affordable screen & battery service. 20-min drive via I-75. Call (478) 259-6371.",
  keywords: ["iPhone repair Byron GA", "phone repair Peach County", "iPhone screen Byron", "cell phone repair Fort Valley"],
};

export default function ByronIPhoneRepairPage() {
  return (
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" />
                  <span>30-minute service while you wait</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" />
                  <span>Water damage & data recovery</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">Directions from Byron</h2>
            <p className="text-lg text-slate-700 mb-4">
              Tech Medics is at <strong>3742 Eisenhower Parkway, Macon</strong> — just 20 minutes north via I-75.
            </p>
            <a
              href="https://www.google.com/maps/dir/Byron,+GA/3742+Eisenhower+Parkway,+Macon,+GA+31206"
              target="_blank"
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Link href="/macon/peach-county-phone-repair" className="text-blue-600 hover:text-blue-800 font-semibold">
                Peach County Phone Repair →
              </Link>
      ...
      <section className="bg-blue-600 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Drive up from Byron today. Most repairs done in 30 minutes.
          </p>
          <a
            href="tel:4782596371"
