...
const Pricing = () => {
  ...
  const handleIssueSelect = (issue: string, basePrice: number) => {
    ...
    const pricingMap: Record<string, any> = {
      ...
      "iPhone X": { lcd: 89.99, backGlass: 149.99, battery: 69.99 },
      "iPhone XS": { lcd: 99.99, backGlass: 149.99, battery: 69.99 },
      "iPhone XS Max": { lcd: 119.99, backGlass: 159.99, battery: 69.99 },
