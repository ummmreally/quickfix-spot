...
const IPadScreenRepair = () => {
  const articleSchema = {
    ...
    "mainEntityOfPage": { "@type": "WebPage", "@id": "https://techmedicsmacon.com/blog/ipad-screen-repair-macon" }
  };
