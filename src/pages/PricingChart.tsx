      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">Complete Pricing Guide</h1>
            ...
            <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
              ...
              <span>
                = Call us at{" "}
                <a href="tel:(478)259-6371" className="text-primary hover:underline font-semibold">
                  (478) 259-6371
                </a>{" "}
                for pricing
              </span>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-muted/50">
                    ...
                    <TableHead className="font-bold text-foreground min-w-[120px] text-center">LCD Screen</TableHead>
                    ...
                    <TableHead className="font-bold text-foreground min-w-[130px] text-center">
                      Apple Original Screen
                    </TableHead>
                    <TableHead className="font-bold text-foreground min-w-[120px] text-center">Back Glass</TableHead>
                    <TableHead className="font-bold text-foreground min-w-[100px] text-center">Battery</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
