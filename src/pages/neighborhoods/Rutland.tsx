...
const Rutland = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Rutland Repair", href: "/macon/rutland" }
  ];

  const landmarks = [
    "Near Bass Road area",
    "Close to Rutland High School",
    "Serving Southwest Macon",
    "Near Houston Road"
  ];
  ...
  const testimonials = [
    {
      name: "Sarah J.",
      rating: 5,
      text: "Great service in Rutland! My iPhone works like new again.",
      date: "2024-01-22",
    ...
    },
    {
      name: "Chris B.",
      rating: 5,
      text: "Convenient location from Rutland. Fast and professional repair.",
      date: "2024-01-17",
    ...
    },
    {
      name: "Jessica H.",
      rating: 5,
      text: "Affordable prices and excellent service. Highly recommend to Rutland residents!",
      date: "2024-01-14",
  ...
  const faqs = [
    {
      question: "Do you serve Rutland and the Bass Road area?",
      answer: "Yes! We're conveniently located with easy access from Rutland and the Bass Road area. We provide fast iPhone, iPad, and MacBook repair services to all Rutland residents. Most repairs completed in 30 minutes or less."
    },
    {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <header className="border-b border-border bg-background sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-center justify-between h-20">
              <img src={logo} alt="MyTechMedics Rutland Macon repair logo" className="h-12 w-auto" />
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-foreground">
                Rutland iPhone, iPad & MacBook Repair Near Me
              </h1>
              <p className="text-xl text-muted-foreground mb-4">
                SERVING RUTLAND, BASS ROAD & SOUTHWEST MACON
              </p>
              <p className="text-lg text-muted-foreground mb-8">
                Located at 3742 Eisenhower Parkway - Easy access from Bass Road
              </p>
        ...
        {/* Serving Rutland Section */}
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 text-foreground">
              Proudly Serving the Rutland Community
            </h2>
        ...
        <section className="py-16 px-4 bg-secondary/30">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-foreground">
              Rutland Device Repair Services
            </h2>
            <p className="text-center text-muted-foreground mb-12 text-lg">
              Expert repair for all Apple devices in Rutland
            </p>
        ...
        <section className="py-16 px-4 bg-secondary/30">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
              Visit Us Today from Rutland
            </h2>
            <p className="text-xl text-muted-foreground mb-8">
              Convenient location from Bass Road and all Southwest Macon areas
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground text-lg px-8">
                <a href="tel:(478)259-6371">
