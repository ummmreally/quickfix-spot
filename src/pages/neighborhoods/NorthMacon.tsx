...
const NorthMacon = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "North Macon Repair", href: "/macon/north-macon" }
  ];

  const landmarks = [
    "Near The Crossing at Macon",
    "Close to North Macon shopping areas",
    "Serving Hartley Bridge Road area",
    "Near Zebulon Road corridor"
  ];

  const localFAQs = [
    {
      question: "Do you serve North Macon and The Crossing area?",
      answer: "Yes! We're conveniently located with easy access from North Macon. We provide fast iPhone, iPad, and MacBook repair services to all North Macon residents. Most repairs completed in 30 minutes or less."
    },
    {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <header className="border-b border-border bg-background sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-center justify-between h-20">
              <img src={logo} alt="MyTechMedics North Macon repair logo" className="h-12 w-auto" />
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-foreground">
                North Macon iPhone, iPad & MacBook Repair Near Me
              </h1>
              <p className="text-xl text-muted-foreground mb-4">
                SERVING NORTH MACON, THE CROSSING & HARTLEY BRIDGE AREA
              </p>
              <p className="text-lg text-muted-foreground mb-8">
                Located at 3742 Eisenhower Parkway - Easy access from North Macon
              </p>
        ...
        {/* Serving North Macon Section */}
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 text-foreground">
              Proudly Serving the North Macon Community
            </h2>
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start">
                      <CheckCircle2 className="mr-2 h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                      <span>Convenient to shopping areas</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="mr-2 h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
        ...
        <section className="py-16 px-4 bg-secondary/30">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-foreground">
              North Macon Device Repair Services
            </h2>
            <p className="text-center text-muted-foreground mb-12 text-lg">
              Expert repair for all Apple devices in North Macon
            </p>
        ...
        <section className="py-16 px-4 bg-secondary/30">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
              Visit Us Today from North Macon
            </h2>
            <p className="text-xl text-muted-foreground mb-8">
              Easily accessible from The Crossing and all North Macon areas
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground text-lg px-8">
                <a href="tel:(478)259-6371">
